...
require (
	...
	github.com/paulusrobin/leaf-utilities/logger/logger v0.0.0-20220413134240-30abf1d47ee7
...
require (
	...
	github.com/paulusrobin/leaf-utilities/database/nosql/nosql v0.0.0-20220413134139-09b3b75d68d3 // indirect
